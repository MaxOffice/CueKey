...
![GitHub release (latest by date)](https://img.shields.io/github/v/release/maxoffice/CueKey?include_prereleases)
...
3. Scale the image as needed
  ...
  * Your choice is persisted for future sessions
4. Save image
...
## Custom keys
You can type any custom key name in the textbox and click `Add`. Maximum 15 characters are supported. The key size will adjust automatically.
